...
public class HelloWorldServer {
    ...
    static class GreeterImpl extends GreeterGrpc.GreeterImplBase {
        ...
        public void sayHello(Helloworld.HelloRequest request, StreamObserver<Helloworld.HelloReply> responseObserver) {
            ...
            String message = "Hello " + request.getFirstName() + " " + request.getLastName() + " (CIN: " + request.getCin() + ")";
        ...
        public void sayHelloAgain(Helloworld.HelloRequest request, StreamObserver<Helloworld.HelloReply> responseObserver) {
            String message = "Hello again " + request.getFirstName() + " " + request.getLastName() + " (CIN: " + request.getCin() + ")";
            Helloworld.HelloReply reply = Helloworld.HelloReply.newBuilder().setMessage(message).build();
            responseObserver.onNext(reply);
            responseObserver.onCompleted();
        }
